...
<p style="margin-top:24px;font-size:12px;color:#64748b">Dashboard complet : <a href="https://www.gmep-france.eu/admin-stats">www.gmep-france.eu/admin-stats</a></p>
  ...
  // ── Rabattement Tool Route (abonnés actifs uniquement) ───────────────────────
  // L'outil est payant (abonnement annuel renouvelable). L'accès est réservé
  // aux utilisateurs authentifiés disposant d'un abonnement actif.
  app.get(
